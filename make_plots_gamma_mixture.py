"""
python make_plots_gamma_mixture.py cyyyymmddhh clead
e.g.,
python make_plots_gamma_mixture.py 2025120812 12

After inference is run with resunet_inference_gamma_mixture_optimized.py, this loads
the netCDF files produced by 2-component Gamma mixture model inference and makes plots.
It's a bit hard-coded to specific cases right now.

This version reads the 2-component Gamma mixture model probability files
with the "_gamma_mixture" suffix.
"""
...
def probability_read(clead, cyyyymmddhh, GRAFprobsdir_conus_laptop):
    ...
    # Updated to read 2-component Gamma mixture model probability files
