...
zoomed in around a specified central lat/lon.

python plot_GRAF_MRMS_zoom.py cyyyymmddhh clead clat clon

e.g,

python plot_GRAF_MRMS_zoom.py 2025100700 12 38.0 -95.0
...
ilead = int(clead)
print ('****** plot_GRAF_MRMS_zoom.py '+ \
    cyyyymmddhh+' '+clead+ \
    ' clat='+str(clat_center)+' clon='+str(clon_center))
cyyyymmdd = cyyyymmddhh[0:8]
cyyyymm = cyyyymmddhh[0:6]
chh = cyyyymmddhh[8:10]
